...
namespace ValidateTestCaseBuilder
{
    public partial class Form1 : Form
    {
        ...
        {
            ExpressionEvaluator<bool> eval1 = ExpressionEvaluatorBuilder<bool>.CreateLogical(textBox1.Text);
        ...
        private void Calc()
        {
            ...
            {
                ExpressionEvaluator<double> eval1 = ExpressionEvaluatorBuilder<double>.CreateNumeric(textBox1.Text);
                dataGridView1.Rows.Clear();
                dataGridView1.ColumnCount = 1;
                dataGridView1.Columns[0].HeaderText = "Результат";
                dataGridView1.Rows.Add();
            ...
            {
                ExpressionEvaluator<bool> eval1 = ExpressionEvaluatorBuilder<bool>.CreateBool(textBox1.Text);
